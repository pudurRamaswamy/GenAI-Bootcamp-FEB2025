...
from src.model import get_openai_response

def text_based(vAR_api_key, vAR_system_instr):
    ...
    with m2:
        ...
        with container:
            ...
            if submit_button and user_input:
                vAR_response = get_openai_response(user_input, vAR_api_key, vAR_system_instr)               

...
st.markdown("<p style='text-align: center; color: black; font-size:25px;'><span style='font-weight: bold'></span>Loan Approval Prediction using Machine Learning</p>", unsafe_allow_html=True)
...
with st.sidebar:
    ...
    vAR_AI_application = st.selectbox("",['Lab-2'],key='application')
...
if vAR_AI_application == "Lab-2":
    main()
# if vAR_AI_application == "APR Q&A":
#     text_based()